...
def open_file():
    try:
        return open("lab4_variant_10.txt")
...
def print_total (header, objects, parameters, maxWidths):
    ...
    print(totalPart)
    print(header_line)
    print('Best object has ' + Fore.RED  + Back.LIGHTWHITE_EX + 'Lightwhite_ex color (' + maxValue + ')' + Style.RESET_ALL)
...
print('\nStart data from file "' + "lab4_variant_10.txt" + '"')
